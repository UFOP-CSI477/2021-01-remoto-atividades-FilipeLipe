                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('user.store')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="exampleInputEmail1" required="required" aria-describedby="emailHelp" placeholder="Nome">
                                            </div>
                                            <div class="form-group">
                                                <small id="emailHelp" class="form-text text-muted">Digite o email do docente</small>
                                                <input type="text" name="email" class="form-control" id="exampleInputPassword1" required="required" placeholder="Email">
                                            </div>
                                            <div class="form-group">
