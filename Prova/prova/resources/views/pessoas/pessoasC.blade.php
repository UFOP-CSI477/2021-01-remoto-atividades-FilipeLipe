                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputPassword1" required="required" placeholder="Bairro">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputPassword1" required="required" placeholder="Cidade">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputPassword1" required="required" placeholder="Estado">
                                            </div>
                                            <div class="form-group">
                                                <input type="date" class="form-control" required="required" id="exampleInputPassword1">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" required="required" id="exampleInputPassword1" placeholder="CPF">
                                                <small id="emailHelp" class="form-text text-muted">Favor digitar o CPF completo sem os pontos e traços</small>
                                            </div>
